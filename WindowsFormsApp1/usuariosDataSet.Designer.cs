...
namespace WindowsFormsApp1 {
    ...
    public partial class usuariosDataSet : global::System.Data.DataSet {
        ...
        public partial class productosDataTable : global::System.Data.TypedTableBase<productosRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public productosRow AddproductosRow(string Nombre, string Cantidad, string Costo, string Proveedor) {
...
namespace WindowsFormsApp1.usuariosDataSetTableAdapters {
    ...
    public partial class productosTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[productos] WHERE (([Id_producto] = @Original_Id_producto) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Cantidad = 1 AND [Cantidad] IS NULL) OR ([Cantidad] = @Original_Cantidad)) AND ((@IsNull_Costo = 1 AND [Costo] IS NULL) OR ([Costo] = @Original_Costo)) AND ((@IsNull_Proveedor = 1 AND [Proveedor] IS NULL) OR ([Proveedor] = @Original_Proveedor)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[productos] ([Nombre], [Cantidad], [Costo], [Proveedor]) VALUES" +
                " (@Nombre, @Cantidad, @Costo, @Proveedor);\r\nSELECT Id_producto, Nombre, Cantidad" +
                ", Costo, Proveedor FROM productos WHERE (Id_producto = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[productos] SET [Nombre] = @Nombre, [Cantidad] = @Cantidad, [Costo] = @Costo, [Proveedor] = @Proveedor WHERE (([Id_producto] = @Original_Id_producto) AND ((@IsNull_Nombre = 1 AND [Nombre] IS NULL) OR ([Nombre] = @Original_Nombre)) AND ((@IsNull_Cantidad = 1 AND [Cantidad] IS NULL) OR ([Cantidad] = @Original_Cantidad)) AND ((@IsNull_Costo = 1 AND [Costo] IS NULL) OR ([Costo] = @Original_Costo)) AND ((@IsNull_Proveedor = 1 AND [Proveedor] IS NULL) OR ([Proveedor] = @Original_Proveedor)));
SELECT Id_producto, Nombre, Cantidad, Costo, Proveedor FROM productos WHERE (Id_producto = @Id_producto)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_producto, Nombre, Cantidad, Costo, Proveedor FROM dbo.productos";
        ...
        public virtual int Fill(usuariosDataSet.productosDataTable dataTable) {
        ...
        public virtual usuariosDataSet.productosDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            usuariosDataSet.productosDataTable dataTable = new usuariosDataSet.productosDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(usuariosDataSet.productosDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id_producto, string Original_Nombre, string Original_Cantidad, string Original_Costo, string Original_Proveedor) {
            ...
            if ((Original_Costo == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[6].Value = ((string)(Original_Costo));
            }
        ...
        public virtual int Insert(string Nombre, string Cantidad, string Costo, string Proveedor) {
            if ((Nombre == null)) {
        ...
        public virtual int Update(string Nombre, string Cantidad, string Costo, string Proveedor, int Original_Id_producto, string Original_Nombre, string Original_Cantidad, string Original_Costo, string Original_Proveedor, int Id_producto) {
            if ((Nombre == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Nombre, string Cantidad, string Costo, string Proveedor, int Original_Id_producto, string Original_Nombre, string Original_Cantidad, string Original_Costo, string Original_Proveedor) {
            return this.Update(Nombre, Cantidad, Costo, Proveedor, Original_Id_producto, Original_Nombre, Original_Cantidad, Original_Costo, Original_Proveedor, Original_Id_producto);
        }
    }
